...
Next, let's consider the `qnorm()` function. Let's say I want to calculate the value at the 95th percentile of the normal distribution:
...
Using the vector `x` above, plot the probability density function for the t-distribution with different degrees of freedom: 1, 2, 10, and100. What do you notice? Compare the t-distribution with df=10000 to the Normal distribution.
